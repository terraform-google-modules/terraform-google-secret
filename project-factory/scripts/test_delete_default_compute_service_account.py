...
class CloudResourceManagerAPITestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        path2 = '{0}/json/crm_get_iam_police.json'.format(dir_path)
    ...
    def mock_set_iam_police(project_id, body):
        return body

    @patch('delete_default_compute_service_account.CloudResourceManagerAPI.'
           'set_iam_police', side_effect=mock_set_iam_police)
    def test_update_iam_polices(self, set_iam_police):
        # The set_iam_police method is replaced with the mock_set_iam_police
        ...
        response = crm_api.update_iam_polices(
...
class IdentityAccessManagementAPITestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        path2 = '{0}/json/crm_get_iam_police.json'.format(self.dir_path)
        path3 = '{0}/json/crm_set_iam_police.json'.format(self.dir_path)
    ...
    def test_delete_default_service_account(self, delete_service_account):
        ...
        # mock_set_iam_police returning the service_account_name parameter
